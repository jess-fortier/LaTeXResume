	...
	\begin{tabular}{@{}p{0.5\textwidth}p{0.5\textwidth}@{}}
		\begin{tabular}{c}
			...
			\begin{tabular}{l}
				...
				- Jira, Azure DevOps Boards, Aha!; \\
				- Python, Java, Ruby, PHP, Javascript, Typescript; \\
				- PostgreSQL, MySQL, SQLite; AWS, Azure. 
				\\
			\end{tabular} 
		\end{tabular}
		&
		\begin{tabular}{r}\\
			\begin{tabular}{c}
				\large \scshape \underline{Leadership Experience} \\
				\begin{tabular}{l}
	...
	\begin{center}
		...
		\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}r}
			...
			% Nava
			  ...
			  \quad   \textbf{Principal Engineering Manager} &
			  \textbf{April 2025 - Present\quad}
			  \\
			  \multicolumn{2}{p{0.5\textwidth}}{\quad AK DOH Medicaid Eligibility -- Account Technical Lead}
			  &
			  {September 2025 - Present \quad\quad\quad\quad}
		  \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Led technical strategy and architecture across three concurrent Medicaid eligibility modernization work streams} \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Managed up to 11 engineers across four scrum teams, including hiring, onboarding, growth planning, and reviews} \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Stood up account-wide engineering governance: shared standards, collaboration processes, and an AI tooling policy} \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Owned the compliance strategy gating launch, sequencing federal and state approvals into the cross-work stream roadmap} \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Partnered with cross-discipline account leadership team to drive portfolio risk management across all work streams} \\ 
		  \\
			  \textbf{} &
			  \quad\quad\quad \textbf{Senior Engineering Manager} &
			  \textbf{November 2022 - April 2025\quad}

			  \\
			  \multicolumn{2}{p{0.5\textwidth}}{\quad NJ Unemployment Insurance (UI) -- Payments Technical Lead}
			  &
			  {January 2024 - April 2025 \quad\quad\quad\quad}
		  \\
			  ...
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Managed up to 13 ICs and managers concurrently; 360 reviews, PIPs, and successful promotion nomination }
		  \\
		  \\
		  ...
		  \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Managed up to four direct reports ranging from early-mid to senior level, including 360 performance reviews} \\
			  \multicolumn{3}{p{\textwidth}}{\quad\quad - Produced an org-level supplemental FAQ for the review process and promotion guidelines for engineers} \\
		...
		\begin{tabular}{p{0.5\textwidth}r}
				\textbf{Master of Science, Computer Science (Dual Specialty)}							&
				\textbf{Portland State University \quad}
			\\
				\quad Programming Language Design \& Applications\quad				&
				{September 2011 - August 2015 \quad\quad}
			\\	
				\multicolumn{2}{p{\textwidth}}{\quad Intelligent \& Adaptive Systems (Artificial Intelligence and Machine Learning)}

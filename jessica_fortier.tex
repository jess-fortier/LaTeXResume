...
\begin{document}
	...
	\begin{tabular}{@{}p{.69\textwidth}r@{}}
		...
		\begin{tabular}{r}
			...
			\\ (253) 970-4449
			\\ tjfortier@gmail.com
			\\ www.github.com/jess-fortier
			\\ www.linkedin.com/in/jessfortier
		\end{tabular} 
	\end{tabular}\hrule
	...
	\begin{center}
		...
		\begin{tabular}{p{0.3\textwidth}p{0.3\textwidth}r}
			...
			% 	UW Institute of Technology							&
			% 	\textbf{September 2009 - December 2010} 
			% \\
			% 	\multicolumn{3}{p{\textwidth}}{\quad\quad - Tutored computer science students in course materials from the freshman to graduate levels} 
			% \\
			% 	\multicolumn{3}{p{\textwidth}}{\quad\quad - Provided technical assistance with course-required software and lab equipment} 
			% \\
			% \\
			% 	\textbf{Summer Instructor}							&
			% 	UW MSL Program										&
			% 	\textbf{July 7, 2010 - August 17, 2010}
			% \\
			% 	\multicolumn{3}{p{\textwidth}}{\quad\quad - Co-instructed $7^{th}$ grade leadership, $8^{th}$ grade robotics, and $10^{th}$ grade mathematics courses} 
			% \\
			% 	\multicolumn{3}{p{\textwidth}}{\quad\quad - Taught $9^{th}$ and $10^{th}$ graders algorithm concepts using the Computer Science Unplugged curriculum} 
			% \\
			% \\
			\\
		\end{tabular}
